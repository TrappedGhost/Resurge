...
namespace Resug
{
	...
	public:
		...
		virtual void UploadFloat2(const std::string name, const glm::dvec2& value) override;
		virtual void UploadFloat3(const std::string name, const glm::dvec3& value) override;
		virtual void UploadFloat4(const std::string name, const glm::dvec4& value) override;
		...
		void UploadUniformFloat2(const std::string name, const glm::dvec2& value);
		void UploadUniformFloat3(const std::string name, const glm::dvec3& value);
		void UploadUniformFloat4(const std::string name, const glm::dvec4& value);
